                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <table class="table table-bordered" style="width: 80%;">
                                <tr>
                                    <th>CIF</th>
                                    <td><input type="text" name='customer_cif' id='customer_cif' style="width: 100%" required autocomplete="off" @isset($ncount) value="{{ $ncount }}" @endif></td>
...
<script src="{{ asset('webcam/jquery3.3.1.min.js')}}"></script>
    ...
    function take_snapshot() {
        Webcam.snap( function(data_uri) {
            ...
            document.getElementById('results').innerHTML = '<img id="myimage1" src="'+data_uri+'" height="340" width="440px"/><br/><p style="text-align: center; font-weight: bold; padding-top: 4px">Customer Photo</p>';
            /*var imgx = document.getElementById('myimage1');
            imgx.style.transform = 'rotate(270deg)';*/
    ...
    function take_snapshot2() {
        Webcam.snap( function(data_uri) {
            ...
            document.getElementById('results2').innerHTML = '<img id="myimage2" src="'+data_uri+'"height="340px" width="440"/><br/><p style="text-align: center; font-weight: bold;">Proof Of Identity</p>';
            /*var imgx = document.getElementById('myimage2');
            imgx.style.transform = 'rotate(270deg)';*/
    ...
    function take_snapshot3() {
        Webcam.snap( function(data_uri) {
            ...
            document.getElementById('results3').innerHTML = '<img id="myimage3" src="'+data_uri+'"height="340px" width="440px"/><br/><p style="text-align: center; font-weight: bold;">Proof of Address</p>';
            /*var imgx = document.getElementById('myimage3');
            imgx.style.transform = 'rotate(270deg)';*/
        } );
    }
                ...
                $.ajax(
                        ...
                        data: {
                            ...
                            success: function(results) 
                            {
                                ...
                                if(results['status']['message']==1)
                                {
                                    //alert('cif already captured');
                                    $('#cifwarning').show();
                                    console.log(results['status']['img1']);
                                    console.log(results['status']['img2']);
                                    console.log(results['status']['img3']);
                                    document.getElementById('stval').innerHTML = 'CIF NO. '+$cifno+' is already captured';  
                                    var link1 = results['status']['img1'];
                                    var link2 = results['status']['img2'];
                                    var link3 = results['status']['img3'];
                                    var maxval1 = `{{ asset('/${link1}') }}`;
                                    var maxval2 = `{{ asset('/${link2}') }}`;
                                    var maxval3 = `{{ asset('/${link3}') }}`;
                                    var timestamp = new Date().getTime();
                                    rand = "?t=" + timestamp;
                                    
                                    document.getElementById('results').innerHTML = '<img id="myimage1" src="'+maxval1+rand+'" height="340" width="440px"/><br/><p style="text-align: center; font-weight: bold; padding-top: 4px">Customer Photo</p>';   
                                    $("#img1").val(maxval1);
                                    document.getElementById('results2').innerHTML = '<img id="myimage2" src="'+maxval2+rand+'"height="340px" width="440"/><br/><p style="text-align: center; font-weight: bold;">Proof Of Identity</p>'; 
                                    $("#img2").val(maxval2); 
                                    document.getElementById('results3').innerHTML = '<img id="myimage3" src="'+maxval3+rand+'"height="340px" width="440px"/><br/><p style="text-align: center; font-weight: bold;">Proof of Address</p>';                           
                                    $("#img3").val(maxval3); 
                                }
                            },
